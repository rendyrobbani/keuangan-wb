...
public final class SubfungsiCodesFactory {

	public static SubfungsiCodes classify(String code) {
		if (code == null) return null;
		if (!code.matches(SubfungsiCodes.REGEX)) return null;
		var codes = code.split("\\.");
		return new SubfungsiCodesImpl(codes[0], codes[1]);
	}

	public static SubfungsiCodes classifyFromKegiatanCode(String code) {
		if (code == null) return null;
